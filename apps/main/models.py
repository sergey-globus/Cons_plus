...
class DocumentTemplate(models.Model):
    ...
    word_document = models.FileField(upload_to='documents\\root\\docx\\', verbose_name="Word документ", blank=True, null=True)
    word_template = models.FileField(upload_to='documents\\root\\docx\\', verbose_name="Word шаблон", blank=True, null=True)
    pdf_template = models.FileField(upload_to='documents\\root\\pdf\\', verbose_name="PDF шаблон", blank=True, null=True)
